...
function readConfig(): AgentConfig {
  ...
  const config: AgentConfig = {
    ...
    allowedActionNames: readCsv(
      ...
      "chat,follow_player,go_to_position,dig_nearest_block,place_block,use_nearest_block,inspect_nearest_container,collect_nearest_item,stop,report_position,world_snapshot,eat_food,retreat_from_threat",
    ),
